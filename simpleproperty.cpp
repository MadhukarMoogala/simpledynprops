...
STDMETHODIMP CSimpleProperty::IsPropertyEnabled( /*[in]*/LONG_PTR objectID,
                                  /*[out]*/BOOL* pbEnabled) 
{
    if (pbEnabled==NULL)
        return E_POINTER;
...
// value for.
STDMETHODIMP CSimpleProperty::GetCurrentValueData( /*in*/LONG_PTR objectID, 
...
// property value for
STDMETHODIMP CSimpleProperty::SetCurrentValueData( /*[in]*/LONG_PTR objectID, 
...
STDMETHODIMP CSimpleProperty::ShowFilterableProperty( /*[in]*/DISPID dispID,
